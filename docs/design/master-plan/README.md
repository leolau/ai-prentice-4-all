...
| [26](./feature-groups/FG-26-users-groups-admin-console.md) | Users admin console + invitation activation (rescoped 2026-08-12: groups out with FG-25; profile assignment settled) | **P6-B** (after FG-29 + FG-27, both merged) | `hermes_cli/members.py` (`MemberService`, `GoTrueAdminClient`), `/api/comms/members*`, FG-20 BFF + `MembersView.tsx`, C5/C8 |
