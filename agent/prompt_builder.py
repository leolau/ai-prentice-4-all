...
KANBAN_GUIDANCE = (
    ...
    "- Do not end on a plain-text \"shall I continue?\" either — nobody reads "
    "it; a turn ending without `kanban_complete`/`kanban_block` is a protocol "
    "violation, retried from scratch. End in exactly one of those two calls.\n"
