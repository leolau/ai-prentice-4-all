...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef(
        "goals",
        "Manage durable goals linked to memory, tasks, and tools",
        "Session",
        gateway_only=True,
        args_hint=(
            "[list | create <title> | priority <id> <priority> | "
            "link <id> <memory|task|tool> <ref> | advance ... | "
            "context <id> | close <id>]"
        ),
    ),
...
#   - version: a one-off build check, not a workflow command; /hermes version.
