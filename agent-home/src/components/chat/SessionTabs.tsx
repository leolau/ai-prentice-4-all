 ...
 *
 * The "Archived" and "+ New" action buttons used to live at the right edge of
 * this strip; they have moved to the `MobileShell` header (via
 * `ChatHeaderActions`) so the chips get the full width.
 */
export function SessionTabs({
  ...
  return (
    <div
      ...
      className="mb-3 flex gap-2 overflow-x-auto pb-1 [-ms-overflow-style:none] [scrollbar-width:thin]"
    >
      {showNew ? (
        newActive ? (
